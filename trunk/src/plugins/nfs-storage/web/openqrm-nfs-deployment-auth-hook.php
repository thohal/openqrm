		...
		switch($cmd) {
			case "start":
				...
				if ($run_disable_deployment_export == 1) {
					...
					fwrite($fp, "fi\n");
					fwrite($fp, "sleep 10\n");
					fwrite($fp, "ln -sf $OPENQRM_SERVER_BASE_DIR/openqrm/plugins/nfs-storage/web/openqrm-nfs-deployment-auth-hook.php $OPENQRM_SERVER_BASE_DIR/openqrm/web/boot-service/openqrm-nfs-deployment-export-auth-hook.$appliance_id.php\n");
					fwrite($fp, "wget -q -O /dev/null \"http://localhost/openqrm/boot-service/openqrm-nfs-deployment-export-auth-hook.$appliance_id.php?bgcmd=stop_deployment_auth&appliance_id=$appliance_id\"\n");
					fwrite($fp, "rm -f $OPENQRM_SERVER_BASE_DIR/openqrm/web/boot-service/openqrm-nfs-deployment-export-auth-hook.$appliance_id.php\n");

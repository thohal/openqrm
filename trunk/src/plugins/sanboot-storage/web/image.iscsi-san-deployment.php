...
function get_image_rootdevice_identifier($sanboot_iscsi_storage_id) {
    ...
    // send command
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/sanboot-storage/bin/openqrm-sanboot-storage post_identifier -t iscsi-san-deployment -u $OPENQRM_USER->name -p $OPENQRM_USER->password";

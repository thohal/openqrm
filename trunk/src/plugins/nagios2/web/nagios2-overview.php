...
$strMsg = '';
	...
	switch (htmlobject_request('action')) {
		case 'map':
			...
			break;
		case 'enable_automap':
			$openqrm->send_command("$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/nagios2/bin/openqrm-nagios-manager automap on");
			$strMsg .= "Enabled automatic mapping of the openQRM Network";
            sleep(4);
			redirect($strMsg);
			break;
		case 'disable_automap':
			$openqrm->send_command("$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/nagios2/bin/openqrm-nagios-manager automap off");

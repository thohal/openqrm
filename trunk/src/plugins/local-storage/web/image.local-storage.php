...
function get_image_rootdevice_identifier($local_storage_storage_id) {
    ...
    // send command
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/local-storage/bin/openqrm-local-storage post_identifier -u $OPENQRM_USER->name -p $OPENQRM_USER->password";

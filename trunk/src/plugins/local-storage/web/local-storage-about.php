...
function local_storage_about() {
	...
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."<b>Additional Local-storage image-parameters for 'grabbing':</b>";
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	...
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."IMAGE_INSTALL_FROM=[path-name-to-loca-storage-image]";
	$disp = $disp."<br>";
	...
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."<b>Additional Local-storage image-parameters for 'deployment':</b>";
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."IMAGE_NFS_MOUNT_OPTIONS=[tcp]";
	$disp = $disp."<br>";

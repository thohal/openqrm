...
function get_image_rootdevice_identifier($iscsi_storage_id) {
	...
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/equallogic-storage/bin/openqrm-equallogic-storage post_identifier -u $OPENQRM_USER->name -p $OPENQRM_USER->password";

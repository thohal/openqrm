...
function get_image_rootdevice_identifier($lvm_iscsi_storage_id) {
    ...
    // send command
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/lvm-storage/bin/openqrm-lvm-storage post_identifier -t lvm-iscsi-deployment -u $OPENQRM_USER->name -p $OPENQRM_USER->password";

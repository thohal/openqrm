		...
		switch($cmd) {
			case "start":
				...
				if ($run_disable_deployment_export == 1) {
					...
					$auth_deployment_stop_cmd = "(ln -sf $OPENQRM_SERVER_BASE_DIR/openqrm/plugins/lvm-storage/web/openqrm-lvm-nfs-deployment-auth-hook.php $OPENQRM_SERVER_BASE_DIR/openqrm/web/boot-service/openqrm-lvm-nfs-deployment-export-auth-hook.$appliance_id.php && screen -dm wget -q -O /dev/null \"http://localhost/openqrm/boot-service/openqrm-lvm-nfs-deployment-export-auth-hook.$appliance_id.php?bgcmd=stop_deployment_auth&appliance_id=$appliance_id\" && rm -f $OPENQRM_SERVER_BASE_DIR/openqrm/web/boot-service/openqrm-lvm-nfs-deployment-export-auth-hook.$appliance_id.php $stop_deployment_hook_file)";
			...
			case "stop":
				...
				$auth_stop_cmd = "(ln -sf $OPENQRM_SERVER_BASE_DIR/openqrm/plugins/lvm-storage/web/openqrm-lvm-nfs-deployment-auth-hook.php $OPENQRM_SERVER_BASE_DIR/openqrm/web/boot-service/openqrm-lvm-nfs-deployment-auth-hook.$appliance_id.php && screen -dm wget -q -O /dev/null \"http://localhost/openqrm/boot-service/openqrm-lvm-nfs-deployment-auth-hook.$appliance_id.php?bgcmd=stop_auth&appliance_id=$appliance_id\" && rm -f $OPENQRM_SERVER_BASE_DIR/openqrm/web/boot-service/openqrm-lvm-nfs-deployment-auth-hook.$appliance_id.php $stop_hook_file)";

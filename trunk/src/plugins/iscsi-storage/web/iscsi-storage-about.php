...
function iscsi_about() {
	...
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."Iscsi-deployment type :";
	$disp = $disp."<br>";
	...
	$disp = $disp."<br>";
	$disp = $disp."- Create an (Iscsi-) Image ('Add Image' in the Immage-overview).";
	...
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."Required Iscsi image-parameters :";
	$disp = $disp."<br>";
	...
	$disp = $disp."<br>";
	$disp = $disp."<br>";
	$disp = $disp."Additional Iscsi image-parameters :";
	$disp = $disp."<br>";

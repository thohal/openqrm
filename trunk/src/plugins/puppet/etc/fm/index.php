<?php
//a:9:{s:4:"lang";s:2:"en";s:9:"auth_pass";s:32:"d41d8cd98f00b204e9800998ecf8427e";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:0:"";s:7:"fm_root";s:48:"@@OPENQRM_WEBSERVER_DOCUMENT_ROOT@@/openqrm/base/plugins/puppet/puppet/";s:17:"cookie_cache_time";i:1096733048;s:7:"version";s:5:"0.9.3";}
/*--------------------------------------------------
 | PHP FILE MANAGER
 +--------------------------------------------------
...
// +--------------------------------------------------
    ...
    $fm_root_atual="@@OPENQRM_WEBSERVER_DOCUMENT_ROOT@@/openqrm/base/plugins/puppet/puppet/";
...
function config_form(){
    ...
    else echo "<tr><td align=right>ꠠ<td><input type=button value=\"".et('ChkVer')."\" onclick=\"test_config_form(1)\">";
    echo "
    ...
    <tr><td>ꠠ<td><input type=button value=\"".et('SavePass')."\" onclick=\"test_config_form(3)\">";
    ...
    function create_zip()
    {
        ...
        foreach($this->files as $current)
        {
            ...
            $translate =  array(''=>pack("C",128),''=>pack("C",129),''=>pack("C",130),''=>pack("C",131),''=>pack("C",132),
                                ...
                                ''=>pack("C",153),''=>pack("C",154),'ܣ'=>pack("C",156),''=>pack("C",157),'_'=>pack("C",158),

...
if ("$OPENQRM_DATABASE_TYPE" == "db2") {
	...
	$APPLIANCE_INFO_TABLE="$OPENQRM_DATABASE_USER.$USER_INFO_TABLE";
}
...
global $KERNEL_INFO_TABLE, $IMAGE_INFO_TABLE, $RESOURCE_INFO_TABLE, $EVENT_INFO_TABLE, $USER_INFO_TABLE, $DEPLOYMENT_INFO_TABLE, $APPLIANCE_INFO_TABLE;
